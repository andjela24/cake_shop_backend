...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<Order> createOrder(@RequestBody AddressDto addressDto, @RequestHeader("Authorization") String jwt) {
...
//        System.out.println("UserDto u kontroleru: " + userDto);
        Order order = orderService.createOrder(user, addressDto);
